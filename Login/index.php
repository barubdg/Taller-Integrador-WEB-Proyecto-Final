        ...
        <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
          <form action="login.php" method="post">
            ...
            <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
              <input type="submit" value="Iniciar Sesion" name="login" class="btn btn-warning btn-lg text-light my-2 py-3" style="width:100% ; border-radius: 30px; font-weight:600;" />
            </div>

          </form><br>
          <p align="center">No tengo una cuenta <a href="register.php" class="text-warning" style="font-weight:600;text-decoration:none;">Registrate aqui.</a></p>
        </div>
      </div>
    </div>
  </section>
